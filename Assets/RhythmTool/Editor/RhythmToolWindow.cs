...
namespace RhythmTool
{
    ...
    public class RhythmToolWindow : EditorWindow
    {
        ...
        {
            Rect rect = new Rect(0, Styles.toolbarHeight + Styles.headerHeight + 10, position.width, Styles.trackHeight);
            ...
            if (waveform)
            {
                int selectedIndex = tracks.FindIndex(track => track.selected);

                if (selectedIndex < 0)
                    selectedIndex = 0;

                rect.y += selectedIndex * (Styles.trackHeight + Styles.trackMargin);
            }
        ...
        private void PasteTrack()
        {
            ...
            Undo.RegisterCompleteObjectUndo(rhythmData, name);
        ...
        private void Refresh(bool setDirty = true)
        {
            ...
            if(setDirty)
                EditorUtility.SetDirty(rhythmData);
        }
